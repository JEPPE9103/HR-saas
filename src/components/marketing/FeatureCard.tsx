...
export function MarketingFeatureCard({ icon, title, children }:{ icon: ReactNode; title: string; children: ReactNode; }){
  return (
    <div className="rounded-2xl border p-5 shadow-md hover:shadow-lg transition border-[var(--ring)] bg-[var(--panel)] hover:border-indigo-300 dark:hover:border-indigo-600">
